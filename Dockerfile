...
ENV CORENLP_ARCHIVE=stanford-corenlp-full-${CORENLP_ARCHIVE_VERSION}.zip \
  ...
  CORENLP_EN=stanford-english-corenlp-${CORENLP_ARCHIVE_VERSION}-models.jar \
  CORENLP_EN_KBP=stanford-english-kbp-corenlp-${CORENLP_ARCHIVE_VERSION}-models.jar
...
RUN wget http://nlp.stanford.edu/software/$CORENLP_EN
RUN wget http://nlp.stanford.edu/software/$CORENLP_EN_KBP
